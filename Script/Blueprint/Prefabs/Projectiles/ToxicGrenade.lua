---@class Newskill1level1_C:UniversalProjectileBase
...
function ToxicGrenade:ReceiveOnImpact(ImpactResult)
    ugcprint("ToxicGrenade:ReceiveOnImpact")
...
function ToxicGrenade:ReceiveLaunchBullet()
    ToxicGrenade.SuperClass.ReceiveLaunchBullet(self)

    ugcprint("ToxicGrenade:ReceiveLaunchBullet")
end

function ToxicGrenade:OnImpactSpawnActor(ImpactResult)
    ugcprint("ToxicGrenade:OnImpactSpawnActor")
    -- fix code
...
--[[
function ToxicGrenade:ReceiveBeginPlay()
    ToxicGrenade.SuperClass.ReceiveBeginPlay(self)
end
--]]

--[[
function ToxicGrenade:ReceiveTick(DeltaTime)
    ToxicGrenade.SuperClass.ReceiveTick(self, DeltaTime)
end
--]]

--[[
function ToxicGrenade:ReceiveEndPlay()
    ToxicGrenade.SuperClass.ReceiveEndPlay(self) 
end
--]]

--[[
function ToxicGrenade:GetReplicatedProperties()
    return
end
--]]

--[[
function ToxicGrenade:GetAvailableServerRPCs()
    return
end
--]]
