---@class skillAlevel2_C:UniversalProjectileBase
...
function skillAlevel2:ReceiveOnImpact(ImpactResult)
    ugcprint("skillAlevel2:ReceiveOnImpact")
...
function skillAlevel2:ReceiveLaunchBullet()
    skillAlevel2.SuperClass.ReceiveLaunchBullet(self)

    ugcprint("skillAlevel2:ReceiveLaunchBullet")
end

function skillAlevel2:OnImpactSpawnActor(ImpactResult)
    ugcprint("skillAlevel2:OnImpactSpawnActor")
    -- fix code
...
--[[
function skillAlevel2:ReceiveBeginPlay()
    skillAlevel2.SuperClass.ReceiveBeginPlay(self)
end
--]]

--[[
function skillAlevel2:ReceiveTick(DeltaTime)
    skillAlevel2.SuperClass.ReceiveTick(self, DeltaTime)
end
--]]

--[[
function skillAlevel2:ReceiveEndPlay()
    skillAlevel2.SuperClass.ReceiveEndPlay(self) 
end
--]]

--[[
function skillAlevel2:GetReplicatedProperties()
    return
end
--]]

--[[
function skillAlevel2:GetAvailableServerRPCs()
    return
end
--]]
