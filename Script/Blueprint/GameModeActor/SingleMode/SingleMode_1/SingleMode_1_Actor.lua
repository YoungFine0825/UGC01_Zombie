...
function SingleMode_1_Actor:ReceiveBeginPlay()
    ...
    if UGCGameSystem.IsServer() then
        ...
        ugcprint(string.format("SingleMode_1_Actor:ReceiveBeginPlay Not Client"))
...
function SingleMode_1_Actor:ReceiveEndPlay()
    ...
    if UGCGameSystem.IsServer() then
        ...
        if AllPlayer and #AllPlayer > 0 then
            ...
            ugcprint("SingleMode_1_Actor:ReceiveEndPlay AllPlayer is nil")
        end
        
    else

        ugcprint("SingleMode_1_Actor:ReceiveEndPlay Not Server")
