...
function SingleMode_2_Actor:ReceiveBeginPlay()
    ...
    if UGCGameSystem.IsServer() then
        ...
        ugcprint(string.format("SingleMode_2_Actor:ReceiveBeginPlay Not Client"))
        ...
        self.ChangeMapTimer = UGCTimerUtility.CreateLuaTimer(0.5, 
            function()
                ...
                ugcprint(string.format("SingleMode_2_Actor:ReceiveBeginPlay ChangeMap is %s", tostring(IsChanegeMapSuccess)))
            end
        , false)
...
function SingleMode_2_Actor:ReceiveEndPlay()
    ...
    if UGCGameSystem.IsServer() then
        ...
        if AllPlayer and #AllPlayer > 0 then
            ...
            ugcprint("SingleMode_2_Actor:ReceiveEndPlay AllPlayer is nil")
        end

    else

        ugcprint("SingleMode_2_Actor:ReceiveEndPlay Not Server")
