...
---@field MonsterType FString
---@field Level int32
---@field KillExp int32
---@field Health float
---@field Defence float
---@field CritDamageResist float
---@field HeadDamageResist float
---@field FireDamageResist float
---@field CounterAttackRatio float
---@field HealthStealRatio float
---@field DropGroupID_Wrapper int32
---@field DropGroupID_Backpack int32
